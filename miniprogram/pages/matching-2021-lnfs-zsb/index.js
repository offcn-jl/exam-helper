Page({
  data: {
    title:"2022人民专业试题比例查询",// 标题
    banner_bk:"http://jl.offcn.com/zg/ty/images/exam-helper/event/2021-lnfs-zsb-index.jpg",// 背景图片
  ...
  async seach_result() {
    ...
    if (this.data.majorValue == ""){
      wx.showToast({ title: '难道没有您中意的专业吗~ _ ~', icon: 'none' })
    }else if (this.data.majorValue !== ""){
      url += "&major=" + this.data.majorValue
      wx.reLaunch({ url })
    }
