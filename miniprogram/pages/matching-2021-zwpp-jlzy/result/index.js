...
Page({
  data: {
    ...
    superiorLink:"/pages/matching-2021-zwpp-jlzy/index", //上级链接
    actid:"43629", //zg99id
  ...
  onLoad: function (options) {
    ...
    // 配置查询条件
    if (typeof options.bumen !== "undefined" && options.bumen !== "不限") this.setData({ "query.bumen": options.bumen })
    if (typeof options.xueli !== "undefined" && options.xueli !== "不限") this.setData({ "query.xueli": options.xueli })
    if (typeof options.major !== "undefined" && options.major !== "不限") this.setData({ "query.major2": options.major })
    this.search();
  },
  /**
   * 生命周期函数--监听页面初次渲染完成
