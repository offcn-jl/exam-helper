Page({
  data: {
    ...
    bumenList:["技术中心","营销中心","投资管理部","延吉卷烟厂","长春卷烟厂"], //部门
    majorList: ["化学","分析化学","有机化学","高分子化学","烟草工程","食品工程","香料香精工艺","生物技术","植物学（香源植物）","市场营销","信息安全","投资学","机械设计制造及自动化","机械工程及自动化","机械电子工程","机械工程","机电一体化工程","暖通","电气工程及自动化","电气信息工程","电子信息工程","计算机科学","统计","会计","企业管理","工商管理","人力资源管理","物流工程","国际贸易","中文","文秘","新闻","法律","财务管理","金融","金融学","经济学","建筑学","公共安全管理","环境工程","环境科学"],//专业类别
    xueliList:["硕士","本科","大专"], //学历
